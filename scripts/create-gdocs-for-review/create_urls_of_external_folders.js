...
var input_path = path.join(__dirname, "../../files/review-by-country/"+country+"/folders_IDs.json");
...
var output_path = path.join(__dirname, "../../files/review-by-country/"+country+"/external_folders_urls.json");
